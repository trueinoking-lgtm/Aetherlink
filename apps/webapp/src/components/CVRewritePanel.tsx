            ...
            <div key={i} className="rounded-lg border border-[var(--border)] p-3">
              ...
              <label className="mt-2 flex items-center gap-2 text-sm cursor-pointer">
                <input
                  ...
                  checked={r.accepted}
                  onChange={() => onToggle(i)}
                  className="accent-[var(--accent)] w-4 h-4 rounded border-[var(--border)] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-1"
                />
                Accept rewrite
              </label>
            </div>
