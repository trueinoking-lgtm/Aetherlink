      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="login-card glass-card p-8">
          ...
          <div className="mb-8 space-y-4">
            ...
            <div className="flex items-start gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[var(--success-bg)]">
            ...
            <div className="flex items-start gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[var(--warning-bg)]">
          ...
          <button
            ...
            disabled={isLoading}
            className="premium-btn premium-btn-secondary w-full disabled:opacity-50 disabled:cursor-not-allowed pointer-active focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-base)]"
          >
            {isLoading ? (
              <>
                <svg
