...
public.profiles (
  ...
  auto_apply_enabled boolean null default true,
  auto_apply_threshold integer null default 80,
  skills text[] null,
  certifications text[] null,
  gmail_email text null,
  gmail_refresh_token_encrypted text null,
  consent_given_at timestamp with time zone null,
  daily_apply_count integer not null default 0,
  daily_apply_reset_at date not null default current_date,
