#!/usr/bin/env python3
"""
CV Journey — Phase 1: Create migration for cv_conversations + generated_cvs tables.
Also updates the existing cv_profiles table with new columns.
"""
import os

migration_sql = '''-- Migration: CV Journey Persistence (cv_conversations, generated_cvs)
...
migration_path = "/root/Aetherlink/apps/backend/supabase/migrations/20260623000003_add_cv_journey.sql"
with open(migration_path, "w") as f:
    f.write(migration_sql)

print(f"✅ Phase 1 migration written: {migration_path}")
